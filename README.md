# NewProj_Latest Configurations

This repository contains all the configuration resources required for the NewProj_Latest project to function properly and expose its business features.
